...
import { Autocomplete, Button, DialogActions, DialogContent, Grid, Link, TextField, Typography } from '@mui/material'
...
export const SchemaComponent = ({ handleClose }) => {
  ...
  const onSaveSegment = async () => {
    ...
    try {
      await axios.post('https://webhook.site/b8f7cf84-87c4-4639-a2d7-1b16300f6c57', request)
      handleClose("SUCCESS")
    } catch (error) {
      handleClose("ERROR")
    }
